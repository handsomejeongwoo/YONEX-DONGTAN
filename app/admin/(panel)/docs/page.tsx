  ...
  return (
    <section style={{ maxWidth: 820 }}>
      ...
      <div style={{ ...CARD, marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 14.5, color: "#3a4c54", margin: 0, lineHeight: 1.8 }}>
          릴스는 영상이라 용량이 크고, 썸네일을 인스타그램에서 따로 받아오는
          방식이라 지금은 관리 화면을 만들지 않았습니다. 사장님 소개 페이지에
          이미 올라가 있는 릴스는 그대로 표시되며, 바꾸거나 추가할 일이 있으면
          담당자에게 말씀해 주세요.
        </p>
      </div>
